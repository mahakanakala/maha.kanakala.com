            ...
            <div className={styles.main}>
                <div className={styles.cardAndEnvelope}>
                    ...
                    <div className={styles.dressCodeContainer}>
                        ...
                        <h4 className={styles.dressCodeDescription}> <b>For Her:</b> Glamorous Evening Attire Cocktail Dresses, or Chic Separates Complementary Colors: Blush, Ivory, Champagne, Gold <br />
